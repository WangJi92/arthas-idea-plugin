...
public class JdkBasicTypeValue implements MultiTypeDefaultValue {
    ...
    public void init() {
        ...
        container.put(Timestamp.class.getName(), new Timestamp(System.currentTimeMillis()));
        ...
        container.put(Object.class.getName(), TypeDefaultValue.DEFAULT_NULL);
        container.put(Enum.class.getName(), TypeDefaultValue.DEFAULT_NULL);
