...
public abstract class BaseArthasPluginAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent event) {
        ...
        try {
            Notification currentNotify = NOTIFICATION.createNotification("命令已经复制", NotificationType.INFORMATION);
     ...
     * @return
     */
    abstract String doBuildCommand(String className, String methodName);
